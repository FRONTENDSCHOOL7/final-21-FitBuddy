...
│─ .gitignore    ──────────────────── 📜 깃 이그노어
│─ .gitmessage   ──────────────────── 📜 커밋 템플릿
│─ .prettierignore ──────────────────── ⚙️ prettier 무시 파일
...
└─ 📂 src
  ...
  │  ├─ ├─ 📂 Common   ──────────────── 📦 Common 컴포넌트
  │  ├─ ├─ ├─ 📂 Alert  ──────────────── 📦 Alert 컴포넌트
  │  ├─ ├─ ├─ 📂 Buttons  ──────────────── ─📦 Buttons 컴포넌트
  │  ├─ ├─ ├─ 📂 Chip  ──────────────────── 📦 Chip 컴포넌트
  │  ├─ ├─ ├─ 📂 Comment  ──────────────── 📦 Comment 컴포넌트
  │  ├─ ├─ ├─ 📂 Icons  ──────────────── 📦 Icons 컴포넌트
  │  ├─ ├─ ├─ 📂 Input  ──────────────── 📦 Input 컴포넌트
  │  ├─ ├─ ├─ 📂 Modal  ──────────────── 📦 Modal 컴포넌트
  │  ├─ ├─ ├─ 📂 Nav  ──────────────── 📦 Nav 컴포넌트
  │  ├─ ├─ ├─ 📂 Placeholder  ──────────────── 📦 Placeholder 컴포넌트
  │  ├─ └─ 📂 KakaoMap   ──────────────── 📦 플레이스 홀더 컴포넌트
  │  ├─ ├─ 📂 Post   ──────────────── 📦 네브바 컴포넌트
